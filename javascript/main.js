            ...
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                ...
                <div class="accordion-body">
                    <ul>
                        ...
                        <li>Vierta yerba dentro del mate hasta alcanzar las tres cuartas partes del mismo. Si lo desea,
                            para
                            que los
                            primeros mates no sean tan amargos, puede agregar una o dos cucharaditas de azúcar.</li>
                        <li>Tape con una mano la boca del mate, inviértalo y agítelo unos instantes. Vuelva el objeto a
                            su
                            posición
                            normal. Cuide que la yerba quede recostada sobre una de las paredes del mate y además se
                            forme
                            un
                            pequeño agujero.</li>
                        <li>Para comenzar el mate, coloque agua tibia suavemente en el hueco que quedó en la yerba.
                            Iniciar
                            el mate
                            con agua tibia, permitirá que no se queme la yerba y pierda el gusto. Deje reposar unos
                            instantes.</li>
                        <li>Introduzca la bombilla en el hueco húmedo.</li>
                        <li>Una vez que hizo estos pasos puede comenzar a cebar el mate.</li>
                        <li>Procure no mover la bombilla y cebar siempre en el mismo lugar, esto permitirá que no moje
                            toda
                            la yerba
                            y así disfrutará más tiempo de unos exquisitos mates.</li>
            ...
            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="/proyecto_mate/images/foto-1.jpg" class="d-block w-100" alt="foto uno">
                    </div>
                    <div class="carousel-item">
                        <img src="/proyecto_mate/images/foto-2.jpg" class="d-block w-100" alt="foto dos">
                    </div>
                    <div class="carousel-item">
                        <img src="/proyecto_mate/images/foto-3.jpg" class="d-block w-100" alt="foto tres">
                    </div>
                    <div class="carousel-item">
                        <img src="/proyecto_mate/images/foto-4.jpg" class="d-block w-100" alt="foto cuatro">
                    </div>
